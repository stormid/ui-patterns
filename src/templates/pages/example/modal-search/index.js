...
const ModalSearch = () => <ExampleLayout>
    <header class="modal-search__container">
        <button class="modal-search__btn js-modal-search__btn" aria-label="Show or hide search form">
        ...
        <div id="modal-search" class="js-modal-search modal" data-modal-toggle="js-modal-search__btn">
            <div class="modal__inner" role="dialog" aria-modal="true" aria-labelledby="modal-label">
                <h2 id="modal-label" class="modal__label">Search this site</h2>
                ...
                <button class="modal__close js-modal-search__btn" aria-label="close">
                    <svg focusable="false" aria-hidden="true" fill="#fff" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
