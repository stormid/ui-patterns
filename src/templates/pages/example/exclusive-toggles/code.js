...
export const OffCanvasNav = () => <nav aria-label={'Primary navigation'}>
    ...
    <ul id="off-canvas-nav" class="off-canvas-nav__list js-off-canvas-nav" data-toggle="js-exclusive-nav__toggle">
...
export const OffCanvasSearch = () => <div class="off-canvas-search__container">
    ...
    <div class="off-canvas-search js-off-canvas-search" id="off-canvas-search" data-toggle="js-exclusive-search__btn">
