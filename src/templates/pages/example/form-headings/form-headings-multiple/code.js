...
export const Code = () => <form class="form js-validate" action="#">
    <h1 class="plus-3 medium">Contact us</h1>
    ...
    <fieldset class="fieldset">
        <legend class="legend">
            Your preferences
            <p class="push-bottom--half baseline">Please tick at least one option below.</p>
            <p class="error-message push-bottom--half" data-valmsg-for="opts" />
        </legend>
        <div class="checkbox">
