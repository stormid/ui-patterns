        ...
        <form class="form js-aria-describedby" action="#">
            ...
            <fieldset class="fieldset">
                ...
                <div class="push-bottom">
                    ...
                    <div class="select">
                        <select data-val="true" data-val-required="Business sector is required" class="select__input" id="f_e5ce0352b486e81180f700505684117c" name="f_e5ce0352b486e81180f700505684117c">
                            <option value="" />
            ...
            <fieldset class="fieldset push-bottom">
                <legend class="visually-hidden">Newsletters</legend>
                <div class="legend checkbox__legend">Please tick as many boxes below to sign up to receive email updates from Seafish. By signing up you agree to receive regular updates.</div>

                <fieldset class="fieldset fieldset--secondary">
                    <legend class="legend legend--secondary">Seafish News</legend>
                    <p class="push-bottom">This is our general update about Seafish work and business critical content.</p>
                    <div class="checkbox">
                ...
                <fieldset class="fieldset fieldset--secondary">
                    ...
                    <p class="push-bottom">Regular updates on the EU-UK Trade and Cooperation agreement and other regulatory information.</p>
                    <div class="checkbox">
                ...
                <fieldset class="fieldset fieldset--secondary">
                    ...
                    <p class="push-bottom">Updates for businesses on how to work more sustainably.</p>
                    <div class="checkbox">
                ...
                <fieldset class="fieldset fieldset--secondary">
                    ...
                    <p class="push-bottom">Updates from our regional managers around the UK.</p>
                    <div class="checkbox">
                ...
                <fieldset class="fieldset fieldset--secondary">
                    ...
                    <p class="push-bottom">Updates about fishing safety and training courses.</p>
                    <div class="checkbox">
                ...
                <fieldset class="fieldset fieldset--secondary">
                    ...
                    <p class="push-bottom">Event information for our Seafood Issues Groups and news on each topic.</p>
                    <div class="checkbox">
            ...
            <fieldset class="fieldset push-bottom">
                <legend class="visually-hidden">Terms and conditions</legend>
                <div class="checkbox is--invalid">
                    ...
                    <label class="checkbox__label" for="f_2e32eb840e98e91180fe00505684117c">
                        I have read and agree to the <a class="link" href="/privacy-policy/" target="_blank">privacy policy</a>
                    </label>
