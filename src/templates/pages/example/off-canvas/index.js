    ...
    <header class="off-canvas__container">
        <div class="off-canvas">
            <nav aria-label={'Primary navigation'}>
                <button class="off-canvas__btn js-off-canvas__toggle" aria-label="Show or hide navigation menu" aria-controls="off-canvas" aria-expanded="false">
                    <svg focusable="false" class="off-canvas__btn-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
