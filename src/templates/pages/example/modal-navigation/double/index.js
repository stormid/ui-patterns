...
export const title = 'Modal navigation real modal example';
    ...
    <header class="modal-nav__container">
        <div class="modal-nav">
            <nav class="modal-nav__modal" aria-label={'Primary navigation'}>
                ...
                <div id="modal-nav" class="js-modal-nav modal-nav__modal-container" data-modal-toggle="js-modal-nav__toggle" hidden>
            ...
            <nav class="modal-nav__inline" aria-label={'Primary navigation'}>
                <ul class="modal-nav__list">
                    <li class="modal-nav__item">
                        <a class={`modal-nav__link`} href={'#'} >Item 1</a>
                    </li>
