...
export const title = 'Modal navigation pseudo modal example';

const ModalNavigation = () => <ExampleLayout>
    <header class="modal-nav__container">
        <div class="modal-nav">
            <nav aria-label={'Primary navigation'}>
                <button class="modal-nav__btn modal-fishy-nav__btn js-modal-fishy-nav__toggle" aria-label="Open navigation" aria-controls="modal-fishy-nav" aria-expanded="false">
