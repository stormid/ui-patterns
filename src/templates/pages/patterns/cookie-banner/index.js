...
const CookieBanner = () => <PatternLayout>
    ...
    <p class="push-bottom--double"><strong>NOTE:</strong>  This implementation has a dependancy on the <a href="https://github.com/stormid/components/tree/master/packages/toggle" target="_blank" rel="noopener noreferrer nofollow">Storm Toggle Component</a>.</p>
