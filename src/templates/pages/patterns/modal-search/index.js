...
const ModalSearch = () => <PatternLayout>
    ...
    <iframe style="--height: 375px" class="example" title="Example modal search" src={'/example/modal-search'}></iframe>
...
`}</code></pre>
    ...
    <ul class="list list--tick push-bottom--double">
        ...
        <li class="list-item">When the search is open, it should not be possible to access the page content beneath via mouse, keyboard, or any other means</li>
