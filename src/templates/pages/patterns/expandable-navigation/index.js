...
const ExpandableNavigation = () => <PatternLayout>
    ...
    <p class="push-bottom--double">Use this pattern for hamburger-type navigation that expands and collapses in the document flow. In contrast Full screen navigation captures focus, takes over the whole screen and prevents interaction with the rest of the page. The expandable navigation pattern remains open when the focus moves out of the navigation.</p>
