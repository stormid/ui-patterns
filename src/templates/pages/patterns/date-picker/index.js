...
const DatePicker = () => <PatternLayout>
    ...
    <p class="push-bottom">This pattern is <b>not</b> recommended for memorable dates (e.g. date of birth), dates from documents or cards (e.g. passport or credit card), or for approximate or partial dates (e.g. January 1970), or relative dates (e.g. 2 days ago). For these kinds of date fields consider the <a rel="noopener nofollow" href="https://design-system.service.gov.uk/components/date-input/">GOV.UK Design System date input</a>, or a simple text field.</p>
...
`}</code></pre>
    ...
    <h3 class="push-bottom--half plus-1 medium">For functional validation</h3>
        <ul class="list list--tick push-bottom--double">
            ...
            <li class="list-item">Space/enter keys should select the focused date, close calendar, focus back on the calendar button, and update the accessible name of the button to indicate the date</li>
