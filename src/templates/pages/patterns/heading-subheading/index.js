...
const ExpandableSearch = () => <PatternLayout>
    ...
    <ul class="list list--tick push-bottom--double">
        ...
        <li class="list-item">Any taglines or subtitles should be <pre class="pre--inline">&lt;p&gt;</pre> tag with an <pre class="pre--inline">aria-roledescription="subtitle"</pre> attribute</li>
    ...
    <ul class="list list--tick push-bottom--double">
        <li class="list-item">Those screenreaders which support <pre class="pre--inline">aria-roledescription</pre> should announce "Subtitle" while reading the tagline or subtitle text.</li>
        <li class="list-item">Those screenreaders which do not support <pre class="pre--inline">aria-roledescription</pre> should announce the text only, with no detrimental effect</li>
