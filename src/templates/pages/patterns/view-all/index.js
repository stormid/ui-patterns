...
const ExpandableSectionViewAll = () => <PatternLayout>
    ...
    <p class="push-bottom--double">This pattern is very similar to the expandable section pattern, but with the addition of a button to show and hide all of the sections at once.  This is a useful shortcut for keyboard and screen reader users and follows a pattern currently in use in the <a href="https://design-system.service.gov.uk/components/accordion/" rel="nofollow noopener">GOV.UK design system</a>.</p>
