...
test.beforeEach(async ({ page }) => {
	await page.goto("/example/heading-subheading/hero");
});


test.describe("Heading with subtitle > Hero >Markup tests", { tag: '@reduced'}, () => {
...
test.describe("Heading with subtitle > Hero > Axe", { tag: '@reduced'}, () => {
